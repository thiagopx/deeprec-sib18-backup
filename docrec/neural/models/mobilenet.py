...
# def mobilenet(input_layer, weights='imagenet', num_classes=1000, seed=None, sess=None):
...
#     }
#     '''
#     input_tensor = Input(tensor=input_layer)
#     mn = MobileNetV2(input_tensor=input_tensor, include_top=False, weights=weights)
#     # include on top of MobileNet
#     x = Conv2D(
...
#     # https://stackoverflow.com/questions/41045729/combine-to-keras-functional-models
...
class MobileNetFC:
    ...
    def __init__(self, input_tensor, num_classes=1000):
        '''
        Reference:
        @article{howard2017mobilenets,
        title={Mobilenets: Efficient convolutional neural networks for mobile vision applications},
