...
results = proposed + proposed_mn + [json.load(open('results/results_{}.json'.format(method), 'r')) for method in methods[2 :]]
...
if len(sys.argv) > 1:
    path = sys.argv[1]
plt.savefig('{}/accuracy.pdf'.format(path), bbox_inches='tight')
